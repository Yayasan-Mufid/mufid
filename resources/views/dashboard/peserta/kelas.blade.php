<x-app-layout>
    ...
    {{-- <aside id="separator-sidebar" class="fixed top-0 left-0 z-20 flex-col flex-shrink-0 hidden w-80 h-full pt-16 font-normal duration-75 lg:flex transition-width transition-transform  -translate-x-full md:translate-x-0" aria-label="Sidebar">
        <div class="relative flex flex-col flex-1 min-h-0 pt-0 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    <ul class="pb-2 space-y-2">
                        ...
                        <li>
                            <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" aria-controls="dropdown-auth" data-collapse-toggle="dropdown-auth" aria-expanded="false">
                            ...
                            <ul id="dropdown-auth" class="py-2 space-y-2 hidden">
                                <li>
            ...
            <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800" sidebar-bottom-menu="">
                ...
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700" id="language-dropdown" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(184px, 2545px);" data-popper-placement="bottom">
    ...
    <div class="p-4 md:ml-80">
        <div class="h-full p-6 flex-1 bg-white divide-y rounded-lg divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
            ...
            <div class="aspect-[16/9]">
                <iframe class="h-full w-full rounded-lg" src="https://www.youtube.com/embed/c72aLHZQM0k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </div>

    <div class="fixed bottom-0 left-0 right-0 z-10">
        <div class="bg-white p-2 md:ml-80 rounded-lg">
            <div class="flex justify-between mb-4">
                <a href="#" class="flex items-center justify-center gap-2 px-4 py-2 border-2 bg-white text-gray-600 rounded-lg hover:bg-gray-300 hover:text-gray-700">
                ...
                <a href="#" class="flex items-center justify-center gap-2 px-4 py-2 border-2 bg-white text-gray-600 rounded-lg hover:bg-gray-300 hover:text-gray-700">
                    Lanjutkan <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
